...
CREATE TABLE BEAR (
    ...
    BEAR_TYPE_ID INTEGER NOT NULL, -- WILL BE A NON-NULLABLE
    CAVE_ID INTEGER -- WILL BE A NULLABLE FK
);
/ -- TO RUN SCRIPTS TOGETHER, NEED A SLASH
...
CREATE TABLE CAVE (
    ...
    MAX_BEARS INTEGER DEFAULT 4 -- 4 BEARS/CAVE
);
/
...
-- CONSTRAINT: RULE BASED ON THE CONTENTS OF A TABLE, LIMITS WHAT MAY BE INSERTED IN A COLUMN
-- TYPES OF CONSTRAINTS: PRIMARY KEY, FOREIGN KEY, UNIQUE, CHECK, NOT NULL, ETC...
-- UNIQUE CONSTRAINT REQUIRES THAT THE VALUE BE UNIQUE WITHIN THAT TABLE

ALTER TABLE BEAR
ADD CONSTRAINT FK_BEAR_BEAR_TYPE
FOREIGN KEY (BEAR_TYPE_ID) REFERENCES BEAR_TYPE(BEAR_TYPE_ID); --REFERENCES TABLE(COLUMN)
/
ALTER TABLE BEAR
...
-- TWO DIFFERENT WAYS TO INSERT: FILLING ALL COLUMNS, OR SPECIFYING WHICH COLUMNS TO FILL

INSERT INTO BEAR_TYPE VALUES (1, 'Grizzly'); -- FILLING ALL COLUMNS
INSERT INTO BEAR_TYPE (BEAR_TYPE_ID, BEAR_TYPE_NAME) VALUES (2,'Polar'); -- SPECIFYING WHICH COLUMNS TO FILL
...
INTO BEAR(BEAR_ID, BEAR_NAME, BIRTHDATE, BEAR_TYPE_ID, CAVE_ID) -- PUTTING VALUES INTO SPECIFIC COLUMNS
VALUES (891, 'Tim', TO_DATE('1902-08-18 00:00:00','yyyy-mm-dd hh24:mi:ss'), 1, 1)
INTO BEAR -- PUTTING VALUES INTO ALL THE COLUMNS OF
...
-- WON'T WORK, INVALID FK
-- INSERT INTO BEAR VALUES (54, 'Brother', TO_DATE('1995-11-11 13:09:00','yyyy-mm-dd hh24:mi:ss'), 100, 2, 2)
...
SELECT CAVE_ID, ROUND(AVG(WEIGHT),2) FROM BEAR -- "ROUND" LIMITS THE NUMBER OF DECIMALS CALCULATED IN THE AVG
GROUP BY CAVE_ID
...
-- GIVE BRUCE AND BETTY SOMEHWERE TO LIVE
...
-- DISPLAY CAVES IN WHICH AVG AGE OF BEARS IS AFTER 1963
...
-- MOVE THRU A RESULT SET USING CURSORS
