...
// static imports whiting a class (ONE CLASS)
import static com.revature.transport.Car.*;

public class GoOnVacation {

	public static void main(String[] args) {
		Vehicle[] vehicles = {new Tornado(140.2), new Kayak("red", 4.2, 2,2), new Car(2021, "spaceship", "Tesla", 50), new Tornado(256.4)};
	...
	static void vacationTime() {
		...
		/* 
		 * stuff in parenthesis is the same as the following
		 * c.setMake("Tesla");
